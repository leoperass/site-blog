...
export const SupportSection = () => {
  return (
    <section className="relative pb-8 md:py-10">
      ...
      <div className="container flex flex-col items-center gap-12 relative z-10">
        <h2 className="font-sans text-gray-100 text-center text-heading-xl text-balance">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-blue-400">
            <div className="flex h-12 w-12 items-center justify-center bg-blue-300 rounded-lg mb-4">
          ...
          <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-cyan-300">
            <div className="flex h-12 w-12 items-center justify-center bg-cyan-200 rounded-lg mb-4">
